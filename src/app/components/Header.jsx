  ...
  return (
    <header>
      <nav className="flex justify-between align-middle px-3 sm:gap-10 md:gap-16 py-3 fixed w-full top-0 bg-dark-blue z-50 text-secondary-text">
        <div>
          <Link className="hover:scale-105 duration-150 sm:hidden" href="/" prefetch={false}>
            <LogoMobile />
          </Link>
          <Link className="hidden hover:scale-105 duration-150 sm:block" href="/" prefetch={false}>
            <LogoDesktop />
          </Link>
        </div>
